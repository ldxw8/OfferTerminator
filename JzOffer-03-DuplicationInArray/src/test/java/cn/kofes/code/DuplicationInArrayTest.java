...
public class DuplicationInArrayTest {
    ...
    public void duplicateWithHash() {
        ...
        int[]  arrays = {2,4,8,1,4,3, 6, 2, 4};
        Assert.assertEquals( DuplicationInArray.duplicateWithHash(arrays, arrays.length, result), true);

        int[]  arrays1 = {2,4,8,1,56, 3, 6, 7, 90, 21, 7, 33, 35, 26, 210, 10, 102, 64, 37, 0, 2};
        Assert.assertEquals( DuplicationInArray.duplicateWithHash(arrays1, arrays1.length, result), true);
